...
public class Money implements Comparable
{
     ...
     * @param obj An object
	 *
	 * @throws an IllegalArgumentException if number is not between 1 and 10.  
	 * @throws an IllegalArgumentException if cents is not between 0 and 99.  
	 * @throws a NullPointerException if obj is null.  
	 * @throws a ClassCastException if obj is not a Money object.  
     * 
    ...
    public Money addMonies (int number, int cents, Object obj) throws Exception
    {
        ...
        {
			throw new  IllegalArgumentException("The number is not between 1 and 10");
		}
		
		if (cents > 99 || cents< 0) 
        {
			throw new  IllegalArgumentException("The cents is not between 0 and 99");
		}
        ...
        {
			throw new ClassCastException("obj is not a Money object");
		}
